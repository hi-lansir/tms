...
export async function addAssignmentsUsingPost(
  ...
  return request<API.BaseResponseInt_>('/api/assignments/add', {
    method: 'POST',
    headers: {
...
export async function deleteAssignmentsUsingPost(
  ...
  return request<API.BaseResponseBoolean_>('/api/assignments/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getAssignmentsByIdUsingGet(
  ...
  return request<API.BaseResponseAssignments_>('/api/assignments/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getAssignmentsVoByIdUsingGet(
  ...
  return request<API.BaseResponseAssignmentsVO_>('/api/assignments/get/vo', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listAssignmentsByPageUsingPost(
  ...
  return request<API.BaseResponsePageAssignments_>('/api/assignments/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listAssignmentsVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageAssignmentsVO_>('/api/assignments/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateAssignmentsUsingPost(
  ...
  return request<API.BaseResponseBoolean_>('/api/assignments/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
